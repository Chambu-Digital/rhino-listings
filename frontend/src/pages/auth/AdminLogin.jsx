    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center p-4 pt-24">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-white mb-2 uppercase tracking-wider" style={{ fontFamily: "'Barlow Condensed', sans-serif" }}>Admin Portal</h1>
          <p className="text-gray-400">Rhino Linings Management System</p>
        </div>
          ...
          <CardContent className="p-8">
            <div className="mb-6">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-xs font-semibold text-orange-500 uppercase tracking-wide">Admin Access Only</span>
              </div>
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-400">
                ...
                <Link to="/admin-setup" className="text-orange-500 hover:text-orange-400 font-medium">
                  Request Access
                </Link>
              </p>
            </div>
        ...
        <div className="mt-6 text-center">
          <div className="bg-gray-900/50 backdrop-blur border border-gray-800 rounded-lg p-4 mb-4">
            <p className="text-sm text-gray-300 mb-2">
              <span className="font-semibold text-orange-500">Admin Portal:</span> Full system access for administrators
            </p>
